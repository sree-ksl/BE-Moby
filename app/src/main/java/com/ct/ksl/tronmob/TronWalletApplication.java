...
import com.ct.ksl.tronmob.wallet.AccountUpdater;
import com.ct.ksl.tronmob.wallet.PriceUpdater;
...
public class TronWalletApplication extends Application implements  LifecycleObserver{
    ...
    public static final String FOREGROUND_CHANGED = "com.ct.ksl.tronmob.app.foreground_changed";
